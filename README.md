# CargoInternationalClient-php

PHP-SDK zur einfachen Integration der Cargo International REST API für Fracht- und Logistikdienste.
...
```json
{
  "repositories": [
    {
      "type": "vcs",
      "url": "https://github.com/kruegge82/cargoInternational.git"
    }
  ],
  "require": {
    "kruegge82/cargointernational": "*@dev"
  }
}
```
