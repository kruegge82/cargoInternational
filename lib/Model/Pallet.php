    ...
    */
    ...
    public function setLoadingMeters($loading_meters)
    {
        ...
        if (($loading_meters < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $loading_meters when calling Pallet., must be bigger than or equal to 0.0.');
        }
    ...
    public function setVolumeCbm($volume_cbm)
    {
        ...
        if (($volume_cbm < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $volume_cbm when calling Pallet., must be bigger than or equal to 0.0.');
        }
