...
class Parcel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setWeight($weight)
    {
        ...
        if (($weight < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling Parcel., must be bigger than or equal to 0.0.');
        }
    ...
    public function setLength($length)
    {
        ...
        if (($length < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $length when calling Parcel., must be bigger than or equal to 0.0.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (($width < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $width when calling Parcel., must be bigger than or equal to 0.0.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if (($height < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $height when calling Parcel., must be bigger than or equal to 0.0.');
        }
