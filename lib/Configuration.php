...
namespace kruegge82\cargoInternational;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://app.spedition.de/api';
    ...
    {
        $report  = 'PHP SDK (kruegge82\cargoInternational) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 0.8' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://app.spedition.de/api",
